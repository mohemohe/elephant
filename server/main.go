...
func main() {
	...
	eh.RegisterRoutes([]echoHelper.Route{
		...
		{echo.POST, "/api/v1/collections", v1.GetCollections, nil},
		{echo.GET, "/api/v1/collections/:id", v1.GetCollections, nil},
		{echo.GET, "/api/v1/requests", v1.GetCollections, nil},
		{echo.POST, "/api/v1/requests", v1.GetCollections, &[]echo.MiddlewareFunc{middlewares.Authorized}},
		{echo.GET, "/api/v1/requests/:id", v1.GetCollections, &[]echo.MiddlewareFunc{middlewares.Authorized}},
		{echo.GET, "/api/v1/votes/:id", v1.GetCollections, nil},
		{echo.PUT, "/api/v1/votes/:id", v1.GetCollections, &[]echo.MiddlewareFunc{middlewares.Authorized}},
		{echo.DELETE, "/api/v1/votes/:id", v1.GetCollections, &[]echo.MiddlewareFunc{middlewares.Authorized}},
